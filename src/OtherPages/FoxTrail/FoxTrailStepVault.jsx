...
const seals = [
  {
    ...
    options: ['smoke', 'coal', 'rain', 'black', 'amber', 'teal', 'rust', 'white', 'gray', 'blue', 'green', 'red', 'orange', 'yellow', 'purple', 'pink', 'brown', 'indigo', 'violet', 'magenta', 'cyan', 'turquoise', 'lavender', 'peach', 'beige', 'cream', 'tan', 'maroon', 'burgundy', 'navy', 'olive', 'lime', 'mint', 'aqua', 'salmon', 'coral', 'fuchsia', 'plum', 'orchid', 'periwinkle', 'sapphire', 'emerald', 'ruby', 'topaz', 'amethyst', 'garnet', 'opal', 'jade', 'onyx', 'quartz', 'citrine', 'tourmaline', 'zircon', 'moonstone', 'sunstone', 'lapis lazuli', 'malachite', 'silver', 'azurite', 'hematite', 'pyrite', 'magnetite', 'rhodonite', 'serpentine', 'tiger eye', 'aventurine', 'chalcedony', 'carnelian', 'jasper', 'agate', 'obsidian', 'sodalite', 'fluorite', 'calcite', 'dolomite', 'gypsum', 'halite', 'limestone', 'marble', 'sandstone', 'shale', 'slate', 'basalt', 'granite', 'andesite', 'diorite', 'gabbro', 'rhyolite', 'tuff'],
    correct: 'silver'
  },
  {
    id: 'creature',
  ...
  },
  {
    ...
    options: ['hopes', 'dreams', 'fears', 'hates', 'wishes', 'prays', 'cries', 'laughs', 'smiles', 'sings', 'dances', 'runs', 'jumps', 'flies', 'swims', 'climbs', 'crawls', 'walks', 'sits', 'stands', 'lies down', 'rests', 'sleeps', 'eats', 'drinks', 'breathes', 'thinks', 'feels', 'touches', 'hears', 'sees', 'tastes', 'smells', 'remembers', 'forgets', 'learns', 'teaches', 'loves', 'creates', 'destroys', 'builds', 'breaks', 'gives', 'takes', 'shares', 'steals', 'helps', 'hurts', 'protects', 'attacks', 'defends', 'offends', 'forgives', 'blames', 'judges', 'accepts', 'rejects', 'welcomes', 'includes', 'excludes', 'embraces', 'avoids', 'confronts', 'evades', 'challenges', 'complies', 'resists', 'submits', 'dominates', 'follows', 'leads'],
    correct: 'loves'
  },
  {
    id: 'home',
    ...
    options: ['mickey', 'minnie', 'simba', 'timon', 'woody', 'buzz', 'nemo', 'dory', 'shrek', 'donkey', 'po', 'shifu', 'toothless', 'hiccup', 'manny', 'sid', 'scrat', 'elsa', 'anna', 'olaf', 'moana', 'maui', 'judy', 'nick', 'lightning', 'mater', 'wall-e', 'eve', 'mushu', 'ariel', 'flounder', 'sebastian', 'belle', 'beast', 'aladdin', 'jasmine', 'genie', 'tarzan', 'jane', 'baloo', 'bagheera', 'mowgli', 'cruella', 'peter', 'tinkerbell', 'pinocchio', 'bambi', 'thumper', 'dumbo', 'timothy', 'lady', 'tramp', 'aristocats', 'marie', 'duchess', 'thomas', 'robin', 'marian', 'pocahontas', 'meeko', 'mulan', 'shang', 'lilo', 'stitch', 'ursula', 'rapunzel', 'flynn', 'pascal', 'merida', 'angus', 'raya', 'sisu', 'mirabel', 'isabela', 'antonio', 'miguel', 'hector', 'coco', 'ernesto'],
    correct: 'scrat'
  }
]
